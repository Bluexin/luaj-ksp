...
@LuajMapped(mapper = TypeAliasMapperTest.Mapper::class)
private typealias MIdentifier = TypeAliasMapperTest.Identifier

class TypeAliasMapperTest {
    ...
    fun `custom mapper on class is used`() {
        val holder = TypeAliasValueTestHolder(id= Identifier("ns", "path"))
    ...
    @LuajExpose
    data class TypeAliasValueTestHolder(
        var id: MIdentifier
    )
